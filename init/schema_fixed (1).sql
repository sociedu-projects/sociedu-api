...
(
    ...
    CONSTRAINT fk_service_package_group
...
-- Optional normalized version table, kept for future package version history.
-- The current seed inserts version, price and duration directly into service_packages.
