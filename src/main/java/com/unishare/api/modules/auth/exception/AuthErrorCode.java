...
public enum AuthErrorCode implements ExceptionCode {
    ...
    REFRESH_TOKEN_REUSED(401, "REFRESH_TOKEN_REUSED"),
    ...
    // Password / Session
    INVALID_CURRENT_PASSWORD(400, "INVALID_CURRENT_PASSWORD"),
    SESSION_NOT_FOUND(404, "SESSION_NOT_FOUND"),

    // Phone
    PHONE_ALREADY_VERIFIED(400, "PHONE_ALREADY_VERIFIED"),
    PHONE_ALREADY_TAKEN(409, "PHONE_ALREADY_TAKEN"),
    INVALID_PHONE_NUMBER(400, "INVALID_PHONE_NUMBER"),

    // Rate Limit
    OTP_RATE_LIMITED(429, "OTP_RATE_LIMITED"),
